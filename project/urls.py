...
router.register(r'links', api_views.Links)
router.register(r'chats-links', api_views.ChatsLinks)
router.register(r'members-links', api_views.MembersLinks)
router.register(r'messages-links', api_views.MessagesLinks)

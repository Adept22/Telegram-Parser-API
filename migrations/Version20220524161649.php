...
final class Version20220524161649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE OR REPLACE FUNCTION telegram_chat_members_decrement() RETURNS TRIGGER AS $$ BEGIN UPDATE telegram.chats SET members_count = members_count - 1 WHERE id = OLD.chat_id; RETURN OLD; END $$ LANGUAGE \'plpgsql\'');
        ...
        $this->addSql('CREATE OR REPLACE FUNCTION telegram_chat_messages_decrement() RETURNS TRIGGER AS $$ BEGIN UPDATE telegram.chats SET messages_count = messages_count - 1 WHERE id = OLD.chat_id; RETURN OLD; END $$ LANGUAGE \'plpgsql\'');
